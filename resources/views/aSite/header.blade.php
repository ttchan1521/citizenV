       ...
       <ul class="nav-links">
        <li>
          ...
          <ul class="sub-menu">
            ...
            <li><a href="{{ route('aSite.phanquyen', ['position' => $user->position ]) }}">Danh sách tỉnh/tp</a></li>
            <li><a href="{{ route('aSite.lichkhaibao', ['position' => $user->position ]) }}">Lịch khai báo</a></li>
          </ul>
        </li>
        <li>
          <div class="iocn-link">
        ...
        <li>
          <div class="iocn-link">
            <a href="{{ route('aSite.thongbao', ['position' => $user->position ]) }}" style="height: 50px!important;">
              <i class='bx bxs-bell'></i>
              <span class="link_name">Thông báo</span>
            </a> 
          </div>
          <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('aSite.thongbao', ['position' => $user->position ]) }}">Thông báo</a></li>
          </ul>
        </li>
        <li>
          <div class="iocn-link">
            <a href="{{ route('aSite.input_citizen', ['position' => $user->position ]) }}" style="height: 50px!important;">
              <i class='bx bxs-contact'></i>
              <span class="link_name">Khai báo dân số</span>
            </a> 
          </div>
          <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('aSite.input_citizen', ['position' => $user->position ]) }}">Khai báo dân số</a></li>
          </ul>
        </li>
        <li>
          <div class="iocn-link">
            <a href="{{ route('aSite.survey', ['position' => $user->position ]) }}" style="height: 50px!important;">
              <i class='bx bxs-user-badge'></i>
              <span class="link_name">Phiếu điều tra</span>
            </a> 
          </div>
          <ul class="sub-menu blank">
            <li><a class="link_name" href="{{ route('aSite.survey', ['position' => $user->position ]) }}">Phiếu điều tra</a></li>
          </ul>
        </li>
        <li>
          <div class="iocn-link">
